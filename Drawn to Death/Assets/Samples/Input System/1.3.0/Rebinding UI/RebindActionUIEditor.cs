...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_DuplicateActionOverlayProperty = serializedObject.FindProperty("m_duplicateActionOverlay");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_DuplicateActionOverlayProperty);
            }
        ...
        private SerializedProperty m_DuplicateActionOverlayProperty;
